					...
					<div class="contact-info d-flex justify-content-between">
						<div class="phone d-flex align-items-center	">
							...
							<span class="ms-2 header-top">
								<b><?php echo esc_html__( 'Chiamaci','technosystem' ); ?></b> <a class=" fw-normal text-dark" href="tel:<?php echo $header_section_phone; ?>"><?php echo $header_section_phone; ?></a> 
							</span>								
						</div>
						...
						<div class="phone d-flex align-items-center	">
							...
							<span class="ms-2 header-top">
								<b><?php echo esc_html__( 'Scrivici','technosystem' ); ?></b> <a class="fw-normal text-dark" href="<?php echo $header_section_email; ?>"><?php echo $header_section_email; ?></a>
							</span>								
						</div>
					</div>
				</div>
				<div class="col-xl-4 offset-3">
					<div class="contact-info d-flex justify-content-between">
						...
						<div class="phone d-flex align-items-center	">
							...
							<span class="ms-2 header-top">
								<a href="<?php echo $header_section_app_url; ?>"><b><?php echo esc_html__( 'Download','technosystem' ); ?> </b><span class="fw-normal text-dark"><?php echo esc_html__( 'our APP','technosystem' ); ?></span></a>
							</span>								
						</div>
						<div class="border"></div>
