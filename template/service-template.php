...
*/
get_header();
$service_page_slider = Kirki::get_option( 'service_page_slider');

$service_page_problem_img = Kirki::get_option( 'service_page_problem_img');
$service_page_problem_title = Kirki::get_option( 'service_page_problem_title');
$service_page_problem_short_desc = Kirki::get_option( 'service_page_problem_short_desc');
$service_page_problem_sub_title = Kirki::get_option( 'service_page_problem_sub_title');

$service_page_discover_title = Kirki::get_option( 'service_page_discover_title');

$service_page_discover_repeater = Kirki::get_option( 'service_page_discover_repeater');
?>
    <!-- heroCarousel -->
    <section class="heroCarousel owl-carousel owl-theme" data-loop="true" data-items="1" data-margin="20"
        ...
        <?php foreach ($service_page_slider as $slide) : ?>
		<div class="banner is-bgImage" style="background-image: url(<?php echo $slide['slider_image'];?>);">
			<div class="agentBannerContent d-flex justify-content-center align-items-center wow fadeInDown"
				...
				<div class="content text-center">
                    <h3 class="titleHints"><?php echo $slide['slider_sub_title'];?></h3>
		...
		<div class="d-flex justify-content-center align-items-center">
			<div class="solution-content">
				<div class="sec-title-area  text-right">
					...
					<span class="sec-sub-tile fw-400"><?php echo $service_page_problem_sub_title; ?></span>
					<h2 class="sec-title fw-700">
                    <?php echo $service_page_problem_title; ?>
					</h2>
					<p class="sec-description fw-400">
                    <?php echo $service_page_problem_short_desc; ?>
					</p>
				</div>
			</div>
			<div class="solution-image">
				<img src="<?php echo $service_page_problem_img; ?>" class="img-fluid w-100" alt="">
			</div>
		</div>
	</section>
	<!--/ problem and solution -->
    ...
    <section class="discover bg-gray section-padding">
        <div class="container">
            <div class="discoverWrapper">
                <h2 class="sec-title fw-700 mb-4"><?php echo $service_page_discover_title; ?></h2>
                <div class="row ">
                    <?php foreach ($service_page_discover_repeater as $discover) : ?>
